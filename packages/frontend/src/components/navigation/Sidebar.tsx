  ...
  return (
    <>
      ...
      <aside
        ...
        className={`
          fixed top-0 left-0 h-full w-64 bg-white dark:bg-secondary-900 shadow-lg border-r border-secondary-200 dark:border-secondary-700 z-30
      ...
      >
        <div className="flex flex-col h-full">
          {/* Logo section */}
          <div className="flex items-center justify-between p-6 border-b border-secondary-200 dark:border-secondary-700 bg-secondary-50 dark:bg-secondary-800">
          ...
          <nav className="flex-1 px-4 py-6 space-y-2 scrollbar-thin">
            {visibleMenuItems.map(item => (
              ...
              >
                <span
                  className={`mr-3 ${isActiveRoute(item.href) ? 'text-white' : 'text-secondary-500 dark:text-secondary-400'}`}
                >
                  {item.icon}
                </span>
                {item.name}
          ...
          <div className="p-4 border-t border-secondary-200 dark:border-secondary-700 bg-secondary-50 dark:bg-secondary-800">
            ...
            <button
              onClick={logout}
              className="w-full flex items-center justify-center px-4 py-2 bg-red-50 hover:bg-red-100 dark:bg-red-900/20 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 rounded-lg text-sm"
            >
