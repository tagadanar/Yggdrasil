...
const statisticsRoutes_1 = __importDefault(require("../../src/routes/statisticsRoutes"));
...
describe('Statistics API Integration Tests', () => {
    beforeEach(() => {
        StatisticsService_1.StatisticsService.clearStorage();
    });
...
//# sourceMappingURL=StatisticsAPI.integration.test.js.map