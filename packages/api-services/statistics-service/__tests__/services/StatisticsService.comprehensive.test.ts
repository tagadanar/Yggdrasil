// Path: packages/api-services/statistics-service/__tests__/services/StatisticsService.comprehensive.test.ts
...
describe('StatisticsService - Comprehensive Tests', () => {
  ...
  describe('System Statistics', () => {
    it('should generate system statistics with all required fields', async () => {
      const result = await StatisticsService.getSystemStatistics('last_30_days');

      expect(result.success).toBe(true);
      expect(result.data).toBeDefined();
      
      const stats = result.data as SystemStatistics;
    ...
    it('should generate different statistics for different timeframes', async () => {
      const result1 = await StatisticsService.getSystemStatistics('last_7_days');
      const result2 = await StatisticsService.getSystemStatistics('last_30_days');
      const result3 = await StatisticsService.getSystemStatistics('last_90_days');

      expect(result1.success).toBe(true);
      expect(result2.success).toBe(true);
      expect(result3.success).toBe(true);

      // Each call should generate new data
  ...
  describe('User Statistics', () => {
    it('should generate user statistics with all required fields', async () => {
      ...
      const result = await StatisticsService.getUserStatistics(userId, 'last_30_days');

      expect(result.success).toBe(true);
      expect(result.data).toBeDefined();
      
      const stats = result.data as UserStatistics;
  ...
  describe('Course Statistics', () => {
    it('should generate course statistics with all required fields', async () => {
      ...
      const result = await StatisticsService.getCourseStatistics(courseId, 'last_30_days');

      expect(result.success).toBe(true);
      expect(result.data).toBeDefined();
      
      const stats = result.data as CourseStatistics;
    ...
    it('should return cached course statistics on subsequent calls', async () => {
      ...
      const result1 = await StatisticsService.getCourseStatistics(courseId, 'last_30_days');
      const result2 = await StatisticsService.getCourseStatistics(courseId, 'last_30_days');
  ...
  describe('Report Generation', () => {
    it('should generate system overview report', async () => {
      ...
      const result = await StatisticsService.generateReport(reportData, 'user123');
    ...
    it('should generate user engagement report', async () => {
      ...
      const result = await StatisticsService.generateReport(reportData, 'admin456');
    ...
    it('should generate course performance report', async () => {
      ...
      const result = await StatisticsService.generateReport(reportData, 'teacher789');
  ...
  describe('Report Management', () => {
    it('should retrieve existing report', async () => {
      ...
      const createResult = await StatisticsService.generateReport(reportData, 'user123');
      const reportId = createResult.report!._id;

      const getResult = await StatisticsService.getReport(reportId, 'user123');
    ...
    it('should reject access to private report by different user', async () => {
      ...
      const getResult = await StatisticsService.getReport(reportId, 'user456');
    ...
    it('should search reports with filters', async () => {
      ...
      await StatisticsService.generateReport({
        type: 'system_overview',
      ...
      const searchResult = await StatisticsService.searchReports(filters, 'user789');
    ...
    it('should paginate search results', async () => {
      ...
      const searchResult = await StatisticsService.searchReports(filters, 'user123');
  ...
  describe('Widget Management', () => {
    it('should create dashboard widget', async () => {
      ...
      const result = await StatisticsService.createWidget(widgetData, 'user123');
    ...
    it('should generate appropriate widget data for different widget types', async () => {
      const widgetTypes: WidgetType[] = ['metric_card', 'chart', 'table', 'progress_bar'];
    ...
    it('should retrieve user widgets', async () => {
      ...
      // Create multiple widgets for user
      await StatisticsService.createWidget({
        type: 'metric_card',
        title: 'Widget 1',
        position: { x: 0, y: 0 },
  ...
  describe('Learning Analytics', () => {
    ...
    it('should validate overview metrics', async () => {
      const result = await StatisticsService.getLearningAnalytics({});
  ...
  describe('Error Handling', () => {
    it('should handle invalid report ID', async () => {
      const result = await StatisticsService.getReport('invalid-id', 'user123');
    ...
    it('should handle empty widget retrieval', async () => {
      const result = await StatisticsService.getUserWidgets('non-existent-user');
  ...
  describe('Data Consistency', () => {
    it('should maintain data consistency across multiple operations', async () => {
      ...
      // Create user and course statistics
      const userResult = await StatisticsService.getUserStatistics(userId, 'last_30_days');
      const courseResult = await StatisticsService.getCourseStatistics(courseId, 'last_30_days');

      expect(userResult.success).toBe(true);
      expect(courseResult.success).toBe(true);

      // Generate reports based on the same data
      const reportResult = await StatisticsService.generateReport({
        type: 'user_engagement',
