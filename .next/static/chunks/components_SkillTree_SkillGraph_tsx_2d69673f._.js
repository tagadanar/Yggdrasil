(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/components_SkillTree_SkillGraph_tsx_2d69673f._.js", {

"[project]/components/SkillTree/SkillGraph.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$force$2f$src$2f$radial$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forceRadial$3e$__ = __turbopack_context__.i("[project]/node_modules/d3-force/src/radial.js [app-client] (ecmascript) <export default as forceRadial>");
...
function SkillGraph({ data, userProgress, onProgressUpdate }) {
    ...
    const logNodePositions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SkillGraph.useCallback[logNodePositions]": (nodes, context)=>{
            console.group(`Node Positions - ${context}`);
            nodes.forEach({
                "SkillGraph.useCallback[logNodePositions]": (node, index)=>{
            ...
            }["SkillGraph.useCallback[logNodePositions]"]);
            console.groupEnd();
        }
    }["SkillGraph.useCallback[logNodePositions]"], []);
    // Update dimensions on window resize
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SkillGraph.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                const handleResize = {
                    "SkillGraph.useEffect.handleResize": ()=>{
                        setDimensions({
                ...
                return ({
                    "SkillGraph.useEffect": ()=>window.removeEventListener('resize', handleResize)
                })["SkillGraph.useEffect"];
            }
        }
    }["SkillGraph.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SkillGraph.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                window.unlock = ({
                    "SkillGraph.useEffect": (level)=>{
                        const domainsAtLevel = data.nodes.filter({
                            "SkillGraph.useEffect.domainsAtLevel": (n)=>n.level === level
                        }["SkillGraph.useEffect.domainsAtLevel"]);
                        if (domainsAtLevel.length > 0) {
                            const node = domainsAtLevel[0];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SkillGraph.useEffect": ()=>{
            ...
            const visibleNodes = data.nodes.filter({
                "SkillGraph.useEffect.visibleNodes": (node)=>node.isUnlocked || node.id === 'join_school'
            }["SkillGraph.useEffect.visibleNodes"]);
            if (visibleNodes.length > 0) {
                ...
                console.log('Spacing Analysis:', {
                    ...
                    minSpacing,
                    nodesPerLevel: {
                        level0: visibleNodes.filter({
                            "SkillGraph.useEffect": (n)=>n.level === 0
                        }["SkillGraph.useEffect"]).length,
                        level1: visibleNodes.filter({
                            "SkillGraph.useEffect": (n)=>n.level === 1
                        }["SkillGraph.useEffect"]).length,
                        level2: visibleNodes.filter({
                            "SkillGraph.useEffect": (n)=>n.level === 2
                        }["SkillGraph.useEffect"]).length
                    }
                });
                ...
                visibleNodes.forEach({
                    "SkillGraph.useEffect": (node, index)=>{
                        const level = node.level;
                        const radius = levelRadii[level] || smallestDimension * 0.5;
                        // Calculate position with more spacing
                        const nodesAtLevel = visibleNodes.filter({
                            "SkillGraph.useEffect.nodesAtLevel": (n)=>n.level === level
                        }["SkillGraph.useEffect.nodesAtLevel"]);
                ...
                const visibleLinks = data.links.filter({
                    "SkillGraph.useEffect.visibleLinks": (link)=>{
                        const sourceNode = visibleNodes.find({
                            "SkillGraph.useEffect.visibleLinks.sourceNode": (n)=>n.id === (typeof link.source === 'string' ? link.source : link.source.id)
                        }["SkillGraph.useEffect.visibleLinks.sourceNode"]);
                        const targetNode = visibleNodes.find({
                            "SkillGraph.useEffect.visibleLinks.targetNode": (n)=>n.id === (typeof link.target === 'string' ? link.target : link.target.id)
                        }["SkillGraph.useEffect.visibleLinks.targetNode"]);
                        return sourceNode && targetNode;
                    }
                }["SkillGraph.useEffect.visibleLinks"]);
                // Create a simulation with stronger forces
                const simulation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$force$2f$src$2f$simulation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forceSimulation$3e$__["forceSimulation"])(visibleNodes).force("center", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$force$2f$src$2f$center$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forceCenter$3e$__["forceCenter"])(centerX, centerY).strength(0.8)).force("link", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$force$2f$src$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forceLink$3e$__["forceLink"])(visibleLinks).id({
                    "SkillGraph.useEffect.simulation": (d)=>d.id
                }["SkillGraph.useEffect.simulation"]).distance(minSpacing).strength(0.5)).force("charge", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$force$2f$src$2f$manyBody$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forceManyBody$3e$__["forceManyBody"])().strength({
                    "SkillGraph.useEffect.simulation": (node)=>node.level === 0 ? -minSpacing * 4 : -minSpacing * 2
                }["SkillGraph.useEffect.simulation"]).distanceMax(minSpacing * 5)).force("collide", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$force$2f$src$2f$collide$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forceCollide$3e$__["forceCollide"])().radius({
                    "SkillGraph.useEffect.simulation": (node)=>{
                        if (node.level === 0) return minSpacing * 0.8;
                        if (node.level === 1) return minSpacing * 1.2;
                        return minSpacing * 0.6;
                    }
                }["SkillGraph.useEffect.simulation"]).strength(0.9).iterations(5)).force("radial", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$force$2f$src$2f$radial$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__forceRadial$3e$__["forceRadial"])({
                    "SkillGraph.useEffect.simulation": (node)=>levelRadii[node.level] || levelRadii[2]
                }["SkillGraph.useEffect.simulation"], centerX, centerY).strength(1)).alphaDecay(0.01).velocityDecay(0.3);
    ...
    const handleNodeClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SkillGraph.useCallback[handleNodeClick]": (node)=>{
            if (node.canUnlock) {
                // Find the corresponding module from the original data
                const domain = data.nodes.find({
                    "SkillGraph.useCallback[handleNodeClick].domain": (n)=>n.level === 1 && n.id === node.group
                }["SkillGraph.useCallback[handleNodeClick].domain"]);
                const moduleData = domain ? __TURBOPACK__imported__module__$5b$project$5d2f$skills$2e$json__$28$json$29$__["default"].domaines_principaux.find({
                    "SkillGraph.useCallback[handleNodeClick]": (d)=>d.id === domain.id
                }["SkillGraph.useCallback[handleNodeClick]"])?.modules.find({
                    "SkillGraph.useCallback[handleNodeClick]": (_, index)=>`${domain.id}_module_${index}` === node.id
                }["SkillGraph.useCallback[handleNodeClick]"]) : null;
                if (moduleData) {
                    const module = {
                        id: node.id,
                        name: node.name,
    ...
    }["SkillGraph.useCallback[handleNodeClick]"], [
        userProgress,
        onProgressUpdate,
        data.nodes
    ]);
    // Custom node painting with progressive reveal
    const paintNode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SkillGraph.useCallback[paintNode]": (node, ctx)=>{
    ...
    }["SkillGraph.useCallback[paintNode]"], [
        hoveredNode
    ]);
    // Custom link painting for curved edges with progressive reveal
    const paintLink = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SkillGraph.useCallback[paintLink]": (link, ctx)=>{
    ...
    }["SkillGraph.useCallback[paintLink]"], []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                ...
                                children: selectedModule.actions_cles.map((action, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                        children: action
                                    }, i, false, {
                                        fileName: "[project]/components/SkillTree/SkillGraph.tsx",
                                        lineNumber: 543,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: selectedModule.concepts_acquis.map((concept, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            Object.entries(selectedModule.skillPoints).map(([skill, value])=>value > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            hoveredNode && !selectedModule && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    Object.entries(hoveredNode.skillPoints).map(([skill, value])=>value > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "skill-point-bar mb-2",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex justify-between text-xs mb-1",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: hoveredNode.isUnlocked ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            lineNumber: 628,
                            columnNumber: 15
                        }, this) : hoveredNode.canUnlock ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(SkillGraph, "i0w5+s/+0M9C+OYfHbcT6ds3ltI=");
_c = SkillGraph;
var _c;
...
"[project]/components/SkillTree/SkillGraph.tsx [app-client] (ecmascript, next/dynamic entry)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.n(__turbopack_context__.i("[project]/components/SkillTree/SkillGraph.tsx [app-client] (ecmascript)"));
}}),
}]);

//# sourceMappingURL=components_SkillTree_SkillGraph_tsx_2d69673f._.js.map